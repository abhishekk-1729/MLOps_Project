...
```bash
zenml integration install mlflow -y
zenml experiment-tracker register mlflow_tracker_customer1 --flavor=mlflow
zenml model-deployer register mlflow --flavor=mlflow
zenml stack register mlflow_stack_customer1 -a default -o default -d mlflow_customer -e mlflow_tracker_customer1 --set
```
